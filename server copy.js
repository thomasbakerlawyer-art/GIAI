...
await resend.emails.send({
  from: "BINANCE GIAI <onboarding@resend.dev>",
  to: user.email,
  subject: "✅ Your Withdrawal Has Been Approved — BINANCE GIAI",
  html: `
<!DOCTYPE html>
<html lang="en">
<head>
...
<td style="padding:32px 28px;color:#202124;">
  ...
  <p style="margin:0 0 18px;font-size:16px;line-height:26px;color:#202124;">
    We are pleased to inform you that your withdrawal request has been reviewed and successfully approved by our team.
  </p>
  <div style="background:#f9f9f9;border-left:4px solid #f0b90b;padding:16px 20px;border-radius:8px;margin:0 0 24px;">
    <p style="margin:0 0 8px;font-size:15px;color:#202124;"><strong>Withdrawal Amount:</strong> $${Number(amount).toLocaleString()}</p>
    <p style="margin:0 0 8px;font-size:15px;color:#202124;"><strong>Status:</strong> <span style="color:#16a34a;font-weight:bold;">Approved ✅</span></p>
    <p style="margin:0;font-size:15px;color:#202124;"><strong>Date:</strong> ${new Date().toLocaleDateString('en-GB', {day:'numeric', month:'long', year:'numeric'})}</p>
  </div>
  <p style="margin:0 0 18px;font-size:16px;line-height:26px;color:#202124;">
    Your account balance has been updated accordingly. Please allow a short processing period for the funds to reflect in your designated wallet or account.
  </p>
  <p style="margin:0 0 28px;font-size:16px;line-height:26px;color:#202124;">
    If you have any questions or require further assistance, please contact GIAI Support directly through the platform. Our team is available around the clock to help.
  </p>
  <a href="https://giai-emoq.onrender.com/dashboard.html"
